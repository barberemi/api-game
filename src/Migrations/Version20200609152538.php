 ...
 */
final class Version20200609152538 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_8D93D6496D55ACAB ON user');
        $this->addSql('ALTER TABLE user ADD user_id INT NOT NULL, DROP academy_id');
    }
}
