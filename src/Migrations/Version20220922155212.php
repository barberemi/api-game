...
final class Version20220922155212 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('UPDATE job SET description = "Le défenseur apporte un x2<img src=\'/game/img/defense.gif\' alt=\"defense\"/> pour la guilde." WHERE name = "defender"');
        ...
        $this->addSql('UPDATE job SET description = "L’ingénieur possède +1<img src=\'/game/img/pa.gif\' alt=\"point action\"/> par jour." WHERE name = "engineer"');
    }
