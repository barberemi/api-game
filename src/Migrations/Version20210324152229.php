...
final class Version20210324152229 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO job (id, name, label, description, created_at, updated_at) VALUES (2, "defender", "Bouclier humain", "Le bouclier humain apporte plus de défense dans la ville.", "'.date_create()->format('Y-m-d H:i:s').'", "'.date_create()->format('Y-m-d H:i:s').'")');
        $this->addSql('INSERT INTO job (id, name, label, description, created_at, updated_at) VALUES (3, "researcher", "Fouineur", "Le fouineur peut utiliser une pelle lors de ses explorations afin d’y trouver des matériaux.", "'.date_create()->format('Y-m-d H:i:s').'", "'.date_create()->format('Y-m-d H:i:s').'")');
